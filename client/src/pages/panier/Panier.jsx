        ...
        case 2:
            const isLogged = user !== null;
                return (<>
                    ...
                    <button class="mt-6 w-full rounded-md bg-blue-500 py-1.5 font-medium text-blue-50 hover:bg-blue-600" onClick={() => {setStep(3);setLoading(true);}} disabled={!verifyStep()}>Continuer</button>
                </>)
        ...
        case 4:
            ...
            return (
                <>
                    ...
                    <Link to="/"><button class="mt-6 w-full rounded-md bg-blue-500 py-1.5 font-medium text-blue-50 hover:bg-blue-600">Retour à l'accueil</button></Link>
                </>
            )
            break;
        case 5:
            ...
            return (
                <>
                    ...
                    <button class="mt-6 w-full rounded-md bg-blue-500 py-1.5 font-medium text-blue-50 hover:bg-blue-600" onClick={() => {setStep(3);setLoading(true);}}>Réessayer</button>
                </>
            )
            break;
